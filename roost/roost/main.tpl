			...
			<div id="filter_options">
				<form method="get" action="{{ 'roost:roost/search'|url }}">
					...
					<div id="buttons">
						...
						<input type="button" value="Advanced options" class="right" id="advanced_toggle" style="margin-right:5px;" />														
					</div>
				...
				{% if properties.length %}
					...
					{% for property in properties %}
						...
						<li id="property-{{ property.uid }}" rel="{{ property.latlon }}|{{ property.type }}">
							<h4 style="display:block;margin-bottom:5px;" class="mmb"><a href="{{ property.urlListing }}">{{ usename }}, {{ property.city }}</a></h4>
							<div class="info_wrap">
								<div class="price">
